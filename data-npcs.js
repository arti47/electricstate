...
export const SPECIAL_ABILITIES = [
  ...
  "One or more built-in weapons (no gear bonus of their own).",
...
export const THREATS = [
  { id: "lawEnforcement", name: "Law Enforcement", category: "violent",
    ...
    countdown: ["The Travelers are accused of a crime.", "Officers question them roughly.",
                "The officers provoke them, trying to start a fight.", "The officers try to arrest them."] },
  ...
  { id: "robot", name: "Robot", category: "technological", isDrone: true,
    ...
    countdown: ["A robot starts acting strangely, off protocol.", "More robots appear and act threateningly.",
                "The robots enforce a lockdown, attacking anyone leaving.", "An NPC is revealed to control them and orders an attack."] },
