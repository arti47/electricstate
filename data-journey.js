...
export const KICKERS = [
  "Gangsters burned the community they lived in to the ground",
  "A sibling missing for months finally made contact, asking for help",
  "They found a corpse in a car loaded with bags of neurine",
  "A revolutionary leader told them it was time to strike back",
  "Their landlord sold the building to a company that wants it empty",
  "The clinic that kept them alive shut its doors overnight",
  "Their prescription ran out and the pharmacy has closed for good",
  "A doctor gave them a number of months",
  "The test came back and they have not told anyone yet",
  "They woke up in a neuroscape they did not log into",
  "Their neurocaster started receiving something nobody sent",
  "A tower went up within sight of the house and the dreams changed",
  "The drones stopped coming to their district",
  "A drone growth walked through the town and did not stop",
  "Every machine in the building spoke their name at once",
  "The network went quiet for six hours and nobody will explain it",
  "Their employer was bought out and the new owners know their history",
  "A corporate agent came to the door and left a card",
  "They were fired in a way that felt like a warning",
  "Their name appeared on a list they were not supposed to see",
  "A warrant was issued in a county they have never visited",
  "The sheriff started parking outside",
  "A patrol unit ran their plates twice in one week",
  "They were arrested, released, and told to leave",
  "The militia set up a checkpoint at the edge of town",
  "Their community voted and they lost",
  "The church they grew up in named them from the pulpit",
  "A cult moved into the empty houses on their street",
  "Someone left an offering on their doorstep",
  "A stranger knew things about them nobody living knows",
  "A face from the war turned up in the diner",
  "Their old unit is meeting and they were the only one not invited",
  "A squadmate died and left them everything",
  "A squadmate died and left them a letter",
  "Someone they left behind in the war has been asking after them",
  "They recognised a voice on the radio",
  "They saw themselves in someone else's photograph",
  "A photograph arrived with no note",
  "A letter arrived thirteen years late",
  "A tape arrived with their name written on it in a dead hand",
  "A phone rang in a booth as they walked past, and it was for them",
  "The broadcast said their hometown, then went to static",
  "They inherited a house they have never seen",
  "They inherited a debt they cannot pay",
  "A creditor stopped sending letters and started sending people",
  "They gambled with money that was not theirs",
  "They were robbed of everything except the car",
  "The car is the only thing the divorce left them",
  "Their partner left and took the children",
  "Their partner left and did not take the children",
  "A child turned up on the porch and called them by name",
  "They found out they are going to be a parent",
  "They found out they already are one",
  "A parent died and the funeral is four states away",
  "A parent is dying and will not wait",
  "They buried someone badly and it has not stayed buried",
  "The grave they visit every year was dug up",
  "They were the only one who walked away from the crash",
  "They caused the crash and nobody knows",
  "The fire was ruled accidental and they know better",
  "They struck someone and did not stop driving",
  "They gave evidence and the person got out anyway",
  "The person they put away has been released",
  "The person they shot survived and has been looking",
  "Their testimony is due and they intend not to give it",
  "A journalist has been asking their neighbours questions",
  "A photograph of them ran in a paper they do not read",
  "Someone posted their address in a neuroscape",
  "A rumour started about them and the town believed it",
  "They were blamed for something a machine did",
  "Their drone came home damaged and they were not flying it",
  "Their drone came home and they cannot get it to power down",
  "A drone they sold has killed somebody",
  "The scrapyard they work found something it should not have",
  "They dug up a piece of the war in their own field",
  "The water in the well changed colour",
  "The crops failed for the third year and the fourth is not coming",
  "The drought reached their road",
  "A dust storm buried the town and they were outside it",
  "The river moved and took the bridge",
  "The dam upstream was condemned",
  "The road out closed and there is one week to use it",
  "The last bus left and they were not on it",
  "The border is closing at the end of the month",
  "Their papers expire before winter",
  "They were told they have a week to be gone",
  "A hospital bed opened up eight hundred miles away",
  "A surgeon who owes them a favour is retiring",
  "The only person who can fix their neurocaster moved west",
  "The part they need was last seen in a boneyard on the coast",
  "The buyer is only in town for the festival",
  "The market opens once a year and it opens next month",
  "The convoy leaves in three days with or without them",
  "The ship sails at the end of the season",
  "A stranger paid them half up front",
  "A job came in with a deadline attached",
  "They were offered money to carry something they did not open",
  "They were paid to carry something sealed, and they opened it",
  "They stole something and cannot put it back",
  "They promised somebody, out loud, in front of witnesses"
];
